# Fix Eventlet SSL Monkey Patching Conflict - MUST BE FIRST
import eventlet
eventlet.monkey_patch()  # Use default monkey patching
...
# Removed duplicate health route - keeping the one at line 1764
